...
public class C5_MarketingTeamShouldBeAbleToCheckStatisticsBoxUnderWorkTime {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //6- Action: Click the check box "Statistics"
        driver.findElement(By.xpath("//*[@name='stats']")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@name='stats']")).click();
        //6- ER: User is able to check and uncheck the "Statistics" box
